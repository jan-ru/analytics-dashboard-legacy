...
/**
 * Process data with filters and sorting (Pure Function)
 * @param {Array} data - Raw data array
 * @param {Object} filters - Filter object { column: value }
 * @param {string} sortColumn - Column to sort by
 * @param {string} sortDirection - 'asc' or 'desc'
 * @returns {Array} - New processed data array
 */
export function processData(data, filters, sortColumn, sortDirection) {
  if (!data || data.length === 0) {
    return [];
  }
